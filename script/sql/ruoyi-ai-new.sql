...
CREATE TABLE `ai_usage_statistics`  (
  ...
  `stat_type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '统计类型（1-日统计，2-周统计，3-月统计）',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID（NULL表示全部用户）',
  `model_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模型名称（NULL表示全部模型）',
  `conversation_count` int NULL DEFAULT 0 COMMENT '对话次数',
  `message_count` int NULL DEFAULT 0 COMMENT '消息数量',
  `total_tokens` bigint NULL DEFAULT 0 COMMENT '总token数',
  `total_cost` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '总费用',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_stat`(`stat_date` ASC, `stat_type` ASC, `user_id` ASC, `model_name` ASC) USING BTREE,
...
-- ----------------------------
-- Records of ai_usage_statistics
-- ----------------------------
...
CREATE TABLE `chat_message_favorite`  (
  ...
  `message_id` bigint NOT NULL COMMENT '消息ID',
  `session_id` bigint NULL DEFAULT NULL COMMENT '会话ID',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '消息内容（冗余存储，方便查询）',
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息收藏表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of chat_message_favorite
-- ----------------------------
...
CREATE TABLE `chat_message_tag`  (
  ...
  `tag_color` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '标签颜色',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '删除标志（0-存在，2-删除）',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息标签表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of chat_message_tag
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息标签关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of chat_message_tag_relation
-- ----------------------------
...
CREATE TABLE `chat_session_share`  (
  ...
  `share_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '分享码（唯一标识）',
  `share_password` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '分享密码（加密存储）',
  `expire_time` datetime NULL DEFAULT NULL COMMENT '过期时间',
  `view_count` int NULL DEFAULT 0 COMMENT '查看次数',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '1' COMMENT '状态（1-有效，0-已取消）',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
